...
execute if entity @e[type=marker,tag=pallet,distance=..1.25 ] unless score @e[type=armor_stand,tag=pallet,limit=1,sort=nearest] state matches 1.. unless score @s progress matches 1.. run function dbd:environment/pallet/drop
